...
module.exports = {
    redeemTokens_invalid_signature: async function redeemTokens_invalid_signature() {
        ...
        await expect(T721Admin.redeemTokens(recipient, amount, accounts[4], code, signature.hex, {from: accounts[5]})).to.eventually.be.rejectedWith('T721Admin::redeemTokens | invalid signature');
