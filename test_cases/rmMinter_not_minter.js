...
module.exports = {
    rmMinter_not_minter: async function rmMinter_not_minter() {
        ...
        await expect(T721Admin.rmMinter(accounts[1])).to.eventually.be.rejectedWith('T721Admin::rmMinter | address is not minter');
    }
};
