...
module.exports = {
    refundedExecute_revert: async function refundedExecute_revert() {
        ...
        await expect(T721Admin.refundedExecute(0, Dummy.address, 0, data, {gasPrice: 1000000000000})).to.eventually.be.rejectedWith('T721Admin::refundedExecute | call reverted');
    }
};
